...
CLabel& CLabel::GetText( CString& strText)
{
	if(IsWindow(this->GetSafeHwnd())) 
	{
		GetWindowText(strText);
...
{
	AfxGetMainWnd()->PostMessage(WM_GET_FLASH_ID, (GetDlgCtrlID() - 1200), 0);
} 

void CLabel::InitToolTip()
{
	if (m_ToolTip.m_hWnd == NULL)
	{
		...
		m_ToolTip.SetTipBkColor(RGB(255, 240, 255));
...
void CLabel::SetTooltipText(LPCTSTR lpszText, BOOL bActivate)
{
...
void CLabel::ActivateTooltip(BOOL bActivate)
{
